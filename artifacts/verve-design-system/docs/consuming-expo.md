# Consuming Verve Design System in Expo apps

Read `artifacts/verve-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/verve-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/verve-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/verve-design-system/lib/native-theme";
import { useColors } from "@workspace/verve-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/verve-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/verve-design-system/components/native/badge";
import { Button } from "@workspace/verve-design-system/components/native/button";
import { Card } from "@workspace/verve-design-system/components/native/card";
```
...
Import and render
`@workspace/verve-design-system/components/native/button`, then run Expo
