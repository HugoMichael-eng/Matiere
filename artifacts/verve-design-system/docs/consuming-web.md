# Consuming Verve Design System in web apps

Read `artifacts/verve-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/verve-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/verve-design-system/styles.css";
```
...
`node_modules/@workspace/verve-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/verve-design-system/components/ui/button";
import { cn } from "@workspace/verve-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/verve-design-system/hooks/use-toast";
```
...
`@workspace/verve-design-system/components/ui/button`. Run the app's typecheck
