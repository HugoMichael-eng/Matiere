# Migrating web UI to Verve Design System

Read `artifacts/verve-design-system/docs/AGENTS.md` and
`artifacts/verve-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/verve-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/verve-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/verve-design-system/hooks/use-toast`
