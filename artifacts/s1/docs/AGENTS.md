# S1 Design System design system
...
workspace package (`@workspace/s1`): other artifacts depend
...
`@workspace/s1/components/...`. Never use a `@/` alias inside
