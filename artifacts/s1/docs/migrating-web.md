# Migrating web UI to S1 Design System

Read `artifacts/s1/docs/AGENTS.md` and
`artifacts/s1/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/s1/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/s1/lib/utils`
- `@/hooks/use-toast` → `@workspace/s1/hooks/use-toast`
