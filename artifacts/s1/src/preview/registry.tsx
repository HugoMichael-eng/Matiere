...
export const DESIGN_SYSTEM = {
  title: 'S1 — Sillage Lab',
  description:
    'Industrial cool-lab aesthetic. Bodoni Moda editorial serif, Jost geometric grotesque, German Yellow on a concrete grey-blue ground.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'The visual foundations and principles of S1.',
  Page: OverviewPage,
};
