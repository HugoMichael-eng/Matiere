# Migrating web UI to S2 Design System

Read `artifacts/s2/docs/AGENTS.md` and
`artifacts/s2/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/s2/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/s2/lib/utils`
- `@/hooks/use-toast` → `@workspace/s2/hooks/use-toast`
