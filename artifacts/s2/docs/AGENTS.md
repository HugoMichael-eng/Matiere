# S2 Design System design system
...
workspace package (`@workspace/s2`): other artifacts depend
...
`@workspace/s2/components/...`. Never use a `@/` alias inside
